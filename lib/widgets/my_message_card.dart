...
class MyMessageCard extends StatefulWidget {
  const MyMessageCard(
      {Key? key, required this.message, required this.hasNip, this.gif, required this.onSwipeLeft, required this.repliedText, required this.userName, required this.repliedMessageType})
      : super(key: key);
            ...
            child: Align(
                ...
                child: ConstrainedBox(
                  ...
                  child:
                      Bubble(
                          margin:
                              BubbleEdges.only(top: 5, right: widget.hasNip ? 0 : 8),
                          ...
                          child: Column(
                            ...
                            children: [
                              widget.repliedText.isNotEmpty ? ConstrainedBox(
                                constraints: bubbleWidth != null ? BoxConstraints(
                                ...
                                child: Container(
                                  decoration: const BoxDecoration(
                                      ...
                                      padding: const EdgeInsets.only(left: 10, top: 5, bottom: 5, right: 30),
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(widget.userName,style: TextStyle(
                                            color: widget.userName == "You" ? tabColor : Colors.deepPurple[200],
                                            fontWeight: FontWeight.bold
                                          ),),
                                          Text(
                                              widget.repliedMessageType.type == "text"
                                                  ? widget.repliedText
                                                  : widget.repliedMessageType.type == "image"
                                                  ? "Photo"
                                                  : widget.repliedMessageType.type == "video"
                                                  ? "Video"
                                                  : widget.repliedMessageType.type == "audio"
                                                  ? "Audio"
                                                  : widget.repliedMessageType.type == "gif"
                                                  ? "Gif" : "",
                                            style: TextStyle(
                                ...
                                children: [
                                  ...
                                  widget.message.messageType.type == "text"
                                      ...
                                      padding: const EdgeInsets.only(
                                          left: 10, right: 10, top: 5),key: _messageKey,
                                    ...
                                    child: Padding(
                                      ...
                                      : widget.message.messageType.type == "gif"
                                      ? SizedBox(
                                      height:
                                      ...
                                      )) : AudioPlayerItem(url: widget.message.text,),
